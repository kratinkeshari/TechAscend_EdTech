...
import Course_Slider from "../components/core/CatalogPage/CorseSlider"
    ...
    if (categoryId) {
      ;(async () => {
        try {
          ...
          console.log("CATALOG PAGE DATA res>>>",res)
        ...
        <div className="py-8">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {catalogPageData?.data?.mostSellingCourses
              ?.slice(0, Math.min(catalogPageData?.data?.mostSellingCourses?.length,4))
              .map((course, i) => (
